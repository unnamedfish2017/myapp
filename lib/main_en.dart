...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _loadMessages() async {
    ...
    if (girlId == 'jsxh') {
      storedMessages = prefs.getStringList('jsxh_messages');
  ...
  Future<void> _saveMessages() async {
    ...
    List<String> storedMessages = _messages
        .where((message) => message['girlId'] == 'jsxh')
        .map((message) => jsonEncode(message))
        .toList();
    await prefs.setStringList('jsxh_messages', storedMessages);
